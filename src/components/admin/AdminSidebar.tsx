...
import { BookOpen, Home, FileText, Users, MessageSquare, GraduationCap, LogOut, Menu, X } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/exercises', icon: FileText, label: 'Exercícios' },
  { href: '/admin/feedback', icon: MessageSquare, label: 'Feedback' },
  { href: '/admin/students', icon: Users, label: 'Alunos' },
  { href: '/admin/posts', icon: BookOpen, label: 'Conteúdo' },
]
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="px-4 pt-4 pb-2">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wider px-3">Painel</p>
        </div>
        ...
        <div className="p-3 border-t border-slate-100">
          <div className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-slate-50 transition-colors group">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-indigo-500 font-medium">Professora</p>
            </div>
            <button
